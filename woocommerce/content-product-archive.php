...
$AlitaStore_shopclass = AlitaStore_Class::AlitaStore_shop_class('');

$colwidth = 4;

if($AlitaStore_shopclass=='shop-fullwidth') {
	if(isset($AlitaStore_opt)){
		$woocommerce_loop['columns'] = $AlitaStore_opt['product_per_row_fw'];
	...
	if(isset($AlitaStore_opt)){
		$woocommerce_loop['columns'] = $AlitaStore_opt['product_per_row'];
		if($woocommerce_loop['columns'] > 0){
			$colwidth = round(12/$woocommerce_loop['columns']);
		}
	}
...
<?php
if ($AlitaStore_viewmode=='grid-view') {
...
<div <?php post_class( $classes ); ?>>
	<div class="product-wrapper"> 
		<div class="list-col4 <?php if($AlitaStore_viewmode=='list-view'){ echo ' col-xs-12 col-sm-4';} ?>">
		...
		<div class="list-col8 <?php if($AlitaStore_viewmode=='list-view'){ echo ' col-xs-12 col-sm-8';} ?>">
			<div class="gridview">
...
if ($AlitaStore_viewmode=='grid-view') {
	$itemindex = 12/ $colwidth;
	if ( ( 0 == ( $woocommerce_loop['loop'] ) % $itemindex || $AlitaStore_productsfound == $woocommerce_loop['loop']) ) {
		echo '</div>';
	} 
}?> 