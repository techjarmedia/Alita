...
<div class="cart-toggler">
	<a href="<?php wc_get_cart_url(); ?>"> 
		...
		<span class="cart-title"><?php esc_html_e('My cart', 'AlitaStore');?></span>
		
		<span class="cart-quantity">
			<?php echo sprintf(_n('%d', '%d', $woocommerce->cart->cart_contents_count, 'AlitaStore'), $woocommerce->cart->cart_contents_count);?>
		</span>
	...
	<div class="mini_cart_inner">
		...
		<ul class="cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">
			...
			<?php else : ?>
				...
				<li class="empty"><?php _e( 'No products in the cart.', 'AlitaStore' ); ?></li>
		...
		<?php if ( ! WC()->cart->is_empty() ) : ?>
			...
			<p class="total"><strong><?php _e( 'Subtotal', 'AlitaStore' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>
