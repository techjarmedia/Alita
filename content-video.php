	...
	<?php 
		if ( is_single() ) { ?>
			<div class="post-thumbnail">
				<?php echo do_shortcode(get_post_meta( $post->ID, '_AlitaStore_post_intro', true )); ?>
			...
			<?php if ( is_single() ) : ?>
				...
				<div class="author-info">
					...
					<div class="author-description">
						<h2><?php esc_html__( 'About the Author:', 'AlitaStore'); printf( '<a href="'.esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ).'" rel="author">%s</a>' , get_the_author()); ?></h2>
