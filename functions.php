...
Class AlitaStore_Class {
	...
	*/
	function AlitaStore_register_required_plugins() {
		...
		$plugins = array(
			array(
				'name'               => esc_html__('TechjarDesign Helper', 'AlitaStore'),
			...
			array(
				'name'               => esc_html__('Mega Main Menu', 'AlitaStore'),
				'slug'               => 'mega_main_menu',
			...
			array(
				'name'               => esc_html__('Revolution Slider', 'AlitaStore'),
				'slug'               => 'revslider',
			...
			array(
				'name'               =>  esc_html__('WPBakery Page Builder', 'AlitaStore'),
				'slug'               => 'js_composer',
			...
			array(
				'name'               => esc_html__('Templatera', 'AlitaStore'),
				'slug'               => 'templatera',
			...
			array(
				'name'               => esc_html__('Essential Grid', 'AlitaStore'),
				'slug'               => 'essential-grid',
			...
			array(
				'name'               => esc_html__('Redux Framework', 'AlitaStore'),
			...
			array(
				'name'      => esc_html__('Contact Form 7', 'AlitaStore'),
				'slug'      => 'contact-form-7',
				'required'  => true,
			),
			array(
				'name'      => esc_html__('Events Manager', 'AlitaStore'),
				'slug'      => 'events-manager',
				'required'  => false,
			),
			array(
				'name'      => esc_html__('Instagram Feed', 'AlitaStore'),
				'slug'      => 'instagram-feed',
				'required'  => true,
			),
			array(
				'name'      => esc_html__('Latest Tweets Widget', 'AlitaStore'),
				'slug'      => 'latest-tweets-widget',
				'required'  => false,
			),
			array(
				'name'      => esc_html__('WS Facebook Like Box Widget', 'AlitaStore'),
			...
			// ),
			array(
				'name'      => esc_html__('MailChimp for WordPress', 'AlitaStore'),
				'slug'      => 'mailchimp-for-wp',
				'required'  => true,
			),
			array(
				'name'      => esc_html__('Shortcodes Ultimate', 'AlitaStore'),
				'slug'      => 'shortcodes-ultimate',
				'required'  => true,
			),
			array(
				'name'      => esc_html__('Simple Local Avatars', 'AlitaStore'),
			...
			array(
				'name'      => esc_html__('TinyMCE Advanced', 'AlitaStore'),
				'slug'      => 'tinymce-advanced',
				'required'  => false,
			),
			array(
				'name'      => esc_html__('Widget Importer & Exporter', 'AlitaStore'),
				'slug'      => 'widget-importer-exporter',
				'required'  => true,
			),
			array(
				'name'      => esc_html__('WooCommerce', 'AlitaStore'),
				'slug'      => 'woocommerce',
				'required'  => true,
			),
			array(
				'name'      => esc_html__('YITH WooCommerce Compare', 'AlitaStore'),
				'slug'      => 'yith-woocommerce-compare',
				'required'  => false,
			),
			array(
				'name'      => esc_html__('YITH WooCommerce Wishlist', 'AlitaStore'),
				'slug'      => 'yith-woocommerce-wishlist',
				'required'  => false,
			),
			array(
				'name'      => esc_html__('YITH WooCommerce Zoom Magnifier', 'AlitaStore'),
